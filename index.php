        ...
        <div class="row">
            ...
            <section class="col-9 pr-5">     
                    <?php 
                        ...
                        // } else if((isset($_GET['debugging']) || (isset($_GET['concatenation']) || (isset($_GET['loop']) || (isset($_GET['function']) || (isset($_GET['del'])) {       

                        } else if(isset($_GET['debugging'])) {
                            echo "<h2>Débogage</h2><br>";
                            echo'<pre>';
                            print_r($table);              // ou   ~~~~    print nl2br(print_r($table, true));          SANS LES BALISES <pre>
                            echo'</pre>';
                        ...
                        } else if(isset($_GET['del'])) {                      // AJOUTER CONFIRMATION
                        session_destroy();
